...
Dist <- function(dist.type) {
  ...
  for (i in 1:length(mass.a)) {
    ...
    write.csv(mass.b[[i]], file = paste0('mass-b-', i, '-', dist.type, '.csv'), row.names = FALSE)
    write.csv(mass.c[[i]], file = paste0('mass-c-', i, '-', dist.type, '.csv'), row.names = FALSE)
    write.csv(mass.d[[i]], file = paste0('mass-d-', i, '-', dist.type, '.csv'), row.names = FALSE)
    write.csv(mass.e[[i]], file = paste0('mass-e-', i, '-', dist.type, '.csv'), row.names = FALSE)
    write.csv(mass.m[[i]], file = paste0('mass-m-', i, '-', dist.type, '.csv'), row.names = FALSE)
    write.csv(mass.p[[i]], file = paste0('mass-p-', i, '-', dist.type, '.csv'), row.names = FALSE)
  }
  ...
  for (i in 1:6) {
    ...
    for (j in 1:7) {
      ...
      if (dist.type == 'gamma') {
        ...
        thk.dist[[j]] <- dgamma(seq(0, 15.24, 0.635), rate = thk.fit[[j]]$estimate[[2]], shape = thk.fit[[j]]$estimate[[1]])
        ...
        thk.dist[[j]] <- dgev(seq(0, 15.24, 0.635), loc = thk.fit[[j]]$estimate[[1]], scale = thk.fit[[j]]$estimate[[2]], shape = thk.fit[[j]]$estimate[[3]])
        ...
        thk.dist[[j]] <- dlnorm(seq(0, 15.24, 0.635), meanlog = thk.fit[[j]]$estimate[[1]], sdlog = thk.fit[[j]]$estimate[[2]])
        ...
        thk.dist[[j]] <- dnorm(seq(0, 15.24, 0.635), mean = thk.fit[[j]]$estimate[[1]], sd = thk.fit[[j]]$estimate[[2]])
        ...
        thk.dist[[j]] <- dpareto(seq(0, 15.24, 0.635), shape = thk.fit[[j]]$estimate$lambda, scale = thk.fit[[j]]$estimate$sigma)
        ...
        thk.dist[[j]] <- dweibull(seq(0, 15.24, 0.635), shape = thk.fit[[j]]$estimate[[1]], scale = thk.fit[[j]]$estimate[[2]])
