...
# set variables
code <- 'mcnp'
source.dir <- 'source' # directory that contains all source files
data.dir <- 'data' # directory that contains MCNP data (build/linux)
...
replot <- TRUE
test.dir <- paste0('E:/test/', loss) # directory that contains model files
val.split <- 0.2
